...
import com.example.tianxi.feitemobile.util.AlbumHelper;
import com.example.tianxi.feitemobile.util.Bimp;
import com.example.tianxi.feitemobile.util.ImageBucket;
...
//    }
    ...
    private class AlbumSendListener implements View.OnClickListener {
        public void onClick(View v) {
            ...
            intent.setClass(mContext, Tab2CreateTopActivity.class);
            startActivity(intent);
            finish();
        }
